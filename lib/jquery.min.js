...
// scrolling-nav.js
$(document).ready(function(){var e=$(".be-header").height();$('a.js-scroll-trigger[href*="#"]:not([href="#"])').on("click",function(t){if(location.pathname.replace(/^\//,"")===this.pathname.replace(/^\//,"")&&location.hostname===this.hostname){var a=$(this.hash);(a=a.length?a:$("[name="+this.hash.slice(1)+"]")).length&&$("html, body").animate({scrollTop:a.offset().top-e+1},1e3,"easeInOutExpo")}}),$(".js-scroll-trigger").click(function(){$(".navbar-collapse").collapse("hide")}),new bootstrap.ScrollSpy(document.body,{target:"#projectNav",offset:e});var t=location.hash;t&&t.length>1&&$(window).on("load",function(){setTimeout(function(){var a,o;a=t,o=$(a),o.length&&$("html, body").animate({scrollTop:o.offset().top-e+1},1e3,"easeInOutExpo")},200)})});
